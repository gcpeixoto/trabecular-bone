...
This script is intended to mesh only the trabecular (g) 
region as follows:
...
save_area_info( fullfile(out,'areasTrabeculae.dat'), As, effective_area, ...
